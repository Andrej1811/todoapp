...
<template>
    <div class="w-full max-w-4xl bg-white/80 backdrop-blur-xl rounded-3xl shadow-2xl shadow-indigo-100 border border-indigo-50/50 overflow-hidden flex flex-col max-h-[calc(100vh-15rem)]">
        <div class="px-6 py-4 border-b border-indigo-50/50 bg-gradient-to-r from-indigo-50/30 to-purple-50/30 flex flex-wrap gap-4 justify-between items-center shrink-0">
        ...
        <div class="grow overflow-auto">
            ...
            <template v-else>
                <table class="w-full text-left border-collapse">
                    <thead class="bg-indigo-50/80 backdrop-blur-md text-indigo-900/40 text-[10px] uppercase tracking-widest font-bold sticky top-0 z-10">
                        <tr>
        ...
        <!-- PAGINATION START -->
        <div class="px-6 py-4 bg-indigo-50/30 border-t border-indigo-50/50 flex justify-between items-center shrink-0">
